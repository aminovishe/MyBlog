<div class="show-widget">
    <div class="div-title-widget d-flex flex-row justify-content-between align-items-center">
        ...
        <a href="allPosts.php?idLabel=1">View all <i class="fas fa-chevron-right"></i></a>
    </div>
            ...
            <div class="col-6">
                <?php for ($i = 1; $i < 5; $i++) { ?>
                    <div class="col-12 d-flex flex-row justify-content-start align-items-start mt-2">
                        <div class="w-35"
                             style="background: url('<?= $showLabelsPostsBusiness[$i]['image'] ?>') center no-repeat;height: 100px;background-size: cover"></div>
