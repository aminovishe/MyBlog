...
WHERE post.category_Id=1 and post.trashed=0
...
INNER JOIN category ON post.category_Id=category.id
INNER JOIN user ON post.author_Id=user.id
WHERE post.category_Id=2 and post.trashed=0
ORDER BY post.creationTimestamp DESC
LIMIT 3");
$stm->execute();
...
INNER JOIN category ON post.category_Id=category.id
INNER JOIN user ON post.author_Id=user.id
WHERE post.category_Id=3 and post.trashed=0
ORDER BY post.creationTimestamp DESC
LIMIT 3");
$stm->execute();
...
INNER JOIN category ON post.category_Id=category.id
INNER JOIN user ON post.author_Id=user.id
WHERE post.category_Id=4 and post.trashed=0
ORDER BY post.creationTimestamp DESC
LIMIT 3");
$stm->execute();
...
INNER JOIN category ON post.category_Id=category.id
INNER JOIN user ON post.author_Id=user.id
WHERE post.category_Id=5 and post.trashed=0
ORDER BY post.creationTimestamp DESC
LIMIT 4");
$stm->execute();
