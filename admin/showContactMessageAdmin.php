...
?>
<?php require_once 'lib/c_showContactMessage.php' ?>
...
<head>
    ...
    <title>Visitor's message - AmiBlog</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                AmiBlog |
                <small>Visitor's message</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="admin.php"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="showContactMessageAdmin.php">Visitor's message</a></li>
            </ol>
        </section>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table id="table_id" class="display">
                        ...
                        <tbody>
                        <?php foreach ($allContactMessage as $key => $value) { ?>
                            <tr>
                                <td><?= $value['contact_creationTimestamp'] ?></td>
                                <td><?= $value['contact_full_name'] ?></td>
                                <td><?= $value['contact_email'] ?></td>
                                <td><?= $value['contact_subject'] ?></td>
                                <td><?= $value['contact_message'] ?></td>
                                <td style="text-align: center">
                                    <a href="#" type="button" class="btn btn-success"><i class="far fa-comment-dots"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
