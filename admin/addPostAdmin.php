            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu menu-open" style="display: block;">
                        ...
                        <li class="treeview-menu-item-active"><a href="addPostAdmin.php"><i class="far fa-circle fa-sm"></i> Add a post</a>
                        </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form action="lib/c_addPostAdmin.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file" id="imageUrl" name="image"
                                   >
                        </div>
                        <div class="form-group">
