...
?>
<?php require_once 'lib/c_showDemandRegister.php' ?>
...
<head>
    ...
    <title>Visitor's demand - AmiBlog</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                AmiBlog |
                <small>Visitor's demand</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="admin.php"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="showContactMessageAdmin.php">Visitor's demand</a></li>
            </ol>
        </section>
                ...
                <div class="box-body">
                    <table id="table_id" class="display">
                        ...
                        <tr>
                            ...
                            <th>Email</th>
                            <th>Reason</th>
                            <th>Reply / Accept / Reject</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($allDemandRegister as $key => $value) { ?>
                            <tr>
                                <td style="width: 10%;"><?= $value['demand_creationTimestamp'] ?></td>
                                <td><?php echo $value['demand_first_name'].' '.$value['demand_last_name'] ?></td>
                                <td><?= $value['demand_email'] ?></td>
                                <td><?= $value['demand_reason'] ?></td>
                                <td style="width: 16%;text-align: center;">
                                    <a href="#" class="btn btn-success btn-sm"><i class="far fa-comment-dots"></i></a>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle fa-sm"></i></a>
                                    <a href="#" class="btn btn-danger btn-sm"><i class="fas fa-minus-circle fa-sm"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
